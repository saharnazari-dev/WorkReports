    ...
    public partial class IdentityDBUser : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 8.0, "User panel", 1, new DateTime(2021, 5, 7, 18, 16, 39, 220, DateTimeKind.Local).AddTicks(9105), 180.0, 500.0, 1 });

            migrationBuilder.InsertData(
                table: "WorkReports",
                columns: new[] { "Id", "DailyWorkHour", "Description", "IsAccepted", "LastWorkedDate", "MonthlyWorkHour", "TotalWorkHour", "UserId" },
                values: new object[] { 2, 7.0, "طراحی سیستم انبار", 0, new DateTime(2021, 5, 7, 18, 16, 39, 223, DateTimeKind.Local).AddTicks(9493), 180.53, 1000.2, 2 });
        }
    }
}
